...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputEmail = (EditText) findViewById(R.id.loginEtMail);
        inputPassword = (EditText) findViewById(R.id.loginEtPwd);
        btnLogin = (Button) findViewById(R.id.loginBLogin);
        btnLinkToRegister = (Button) findViewById(R.id.loginBRegister);
            ...
            public void onClick(View view) {
                ...
                if (!email.isEmpty() && !password.isEmpty()) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Veuillez remplir tout le formulaire !", Toast.LENGTH_LONG)
                            .show();
                }
            }
